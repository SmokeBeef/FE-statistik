  ...
  <div className="flex justify-center flex-grow">
    <div className="flex justify-center gap-5 items-center">
      ...
      <a
        href="/team"
        className={`text-lg text-white py-5 text-center hover:text-2xl hover:text-gray-800 transition-all ${
          window.location.pathname === "/team" ? "text-2xl text-gray-800 " : ""
        }`}
      >
        Team
      </a>
      <a
        href="/player"
        className={`text-lg text-white py-5 text-center hover:text-2xl hover:text-gray-800 transition-all ${
          window.location.pathname === "/player" ? "text-2xl text-gray-800 " : ""
        }`}
      >
        Player
      </a>
      <a
        href="/detail"
        className={`text-lg text-white py-5 text-center hover:text-2xl hover:text-gray-800 transition-all ${
          window.location.pathname === "/detail" ? "text-2xl text-gray-800 " : ""
        }`}
      >
        Detail
      </a>
